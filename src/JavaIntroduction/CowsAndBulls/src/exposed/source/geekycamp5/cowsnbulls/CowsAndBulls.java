package exposed.source.geekycamp5.cowsnbulls;
...
import exposed.source.geekycamp5.cowsnbulls.players.UltraSmartArtificialIntelligencePlayer;
...
public class CowsAndBulls {
    ...
    static {
        PLAYER_IMPLEMENTATIONS.put("computer", new UltraSmartArtificialIntelligencePlayer(rules));
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (; ; ) {
            ...
            System.out.println("Press enter for another game");
            System.in.read();
        }
    }
